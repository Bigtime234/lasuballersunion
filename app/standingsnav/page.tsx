...
export default function MensStandingsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 py-12">
        ...
        {/* Header */}
        <div className="mb-8">
          <Link href="/" className="inline-flex items-center gap-2 text-green-400 hover:text-green-300 font-bold mb-4 transition">
            <ArrowLeft size={20} />
            Back to Men's Home
          </Link>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-slate-900/50 rounded-2xl border border-slate-700">
            ...
            <button onClick={() => window.location.reload()} className="px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-bold transition">
              Try Again
            </button>
          </div>
        ) : standings.length > 0 ? (
